...
namespace diablo2 {
	...
	public:
		...
		static BOOL get_free_belt_slot(structures::inventory* inv, structures::unit* item, int32_t* free_slot);
		static BOOL place_item_in_belt_slot(structures::inventory* inv, structures::unit* item, int32_t slot);
